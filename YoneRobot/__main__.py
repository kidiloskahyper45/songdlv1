...
PM_START_TEXT = """
ʜᴇʟʟᴏ [🎗](https://telegra.ph/file/0dfcbdb6aafed760ffb00.jpg), ɪᴍ Ξ L I Z Λ B Ξ TH ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
`ɪ'ᴍ ʜᴇʀᴇ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘꜱ! ʜɪᴛ` /help   Credit @kerela_songstore
"""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ʏᴏɴᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/ELIZABETHTG_bot?startgroup=true"),
    ],
    [
...
HELP_STRINGS = """
`ʜɪ.. ɪ'ᴍ` [Ξ L I Z Λ B Ξ TH](https://telegra.ph/file/0dfcbdb6aafed760ffb00.jpg) 
`ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴꜱ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴅᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ꜱᴘᴇᴄɪꜰɪᴄ ᴍᴏᴅᴜʟᴇꜱ..`"""

yone_IMG = "https://telegra.ph/file/0dfcbdb6aafed760ffb00.jpg"
...
def yone_about_callback(update, context):
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text="""  I'm *Ξ L I Z Λ B Ξ TH*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_Ξ L I Z Λ B Ξ TH's licensed under the GNU General Public License v3.0_
                 \nHere is the [💾Repository](https://github.com/kidiloskahyper45).
                 \n\nIf you have any question about Ξ L I Z Λ B Ξ TH let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
